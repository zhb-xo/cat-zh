dojo.declare("classes.managers.Achievements", com.nuclearunicorn.core.TabManager, {
    ...
    badges: [
        ...
        { 
            ...
            title: "华丽毛色",
            description: "当小猫的名字显示为彩色时，这仅仅表示该小猫拥有稀有毛色，它不会带来任何特殊的游戏效果。",
            difficulty: "F",
            condition: function() {
                var leader = this.game.village.leader;
            ...
            name: "whatYearIsIt",
            title: "今夕是何年？",
            description: "有效地解决时间悖论，可能有未知的副作用。",
            difficulty: "C"
        },{
            name: "tardis",
            title: "时空相对维度空间",
            description: "时间旅行优先于太空旅行。",
            difficulty: "C"
        },{
    ...
    update: function () {
        ...
        if (this.game.rand(100) < 10) {
            ...
            this.getBadge("lostDates").title = "消失的日子";
        }
    },
